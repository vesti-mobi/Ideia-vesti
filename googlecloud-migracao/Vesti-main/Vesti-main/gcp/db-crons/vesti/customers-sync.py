...
LOG_FILE = "/home/diego/crons/sync_customers_daily.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
CSV_FILE = "/tmp/spooling_temp_customers_daily.csv"
...
def run_sync():
    logging.info("--- Iniciando carga diária (dia anterior) de customers ---")
