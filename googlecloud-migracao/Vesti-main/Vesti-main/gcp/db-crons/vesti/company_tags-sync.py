...
LOG_FILE = "/home/diego/crons/sync_company_tags.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
CSV_FILE = "/tmp/spooling_temp_company_tags.csv"
...
QUERY = """
SELECT
    id, domain_id, tag_id, company_id, created_at, updated_at
FROM company_tags
...
def run_sync():
    logging.info("--- Iniciando sincronização de company_tags (diária) ---")
