...
LOG_FILE = "/home/diego/crons/sync_partners.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
CSV_FILE = "/tmp/spooling_temp_partners.csv"
...
SELECT
    ...
    provider_subaccount_id, provider_token, slug, email
FROM partners
...
def run_sync():
    logging.info("--- Iniciando sincronização de partners (diária) ---")
