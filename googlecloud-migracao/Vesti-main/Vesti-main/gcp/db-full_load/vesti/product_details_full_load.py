...
LOG_FILE = "/home/diego/populate/full_load_product_details.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
CSV_FILE = "/tmp/full_load_temp_product_details.csv"
...
def run_full_load():
    logging.info("--- Iniciando Carga Completa (Massiva) de Product Details via OFFSET ---")
    ...
    try:
        ...
        with SSHTunnelForwarder(
            ...
            # SOMENTE estas - as colunas NUMERIC (precos) sao preservadas.
            int_columns = [
