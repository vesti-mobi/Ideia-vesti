...
LOG_FILE = "/home/diego/populate/full_load_states.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
CSV_FILE = "/tmp/full_load_temp_states.csv"
...
def run_full_load():
    logging.info("--- Iniciando Carga Completa (Massiva) de States via OFFSET ---")
