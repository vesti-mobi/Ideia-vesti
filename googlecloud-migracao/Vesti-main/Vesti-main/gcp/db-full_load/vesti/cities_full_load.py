...
LOG_FILE = "/home/diego/populate/full_load_cities.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
CSV_FILE = "/tmp/full_load_temp_cities.csv"
...
def run_full_load():
    logging.info("--- Iniciando Carga Completa (Massiva) de Cities via OFFSET ---")
