...
LOG_FILE = "/home/diego/populate/full_load_partners.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
CSV_FILE = "/tmp/full_load_temp_partners.csv"
...
def run_full_load():
    logging.info("--- Iniciando Carga Completa (Massiva) de Partners via OFFSET ---")
    ...
    try:
        ...
        with SSHTunnelForwarder(
            ...
            while True:
                ...
                query = f"SELECT * FROM partners ORDER BY id ASC LIMIT {BATCH_SIZE} OFFSET {offset}"
