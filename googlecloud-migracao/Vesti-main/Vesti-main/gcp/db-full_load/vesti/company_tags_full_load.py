...
LOG_FILE = "/home/diego/populate/full_load_company_tags.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
CSV_FILE = "/tmp/full_load_temp_company_tags.csv"
...
def run_full_load():
    logging.info("--- Iniciando Carga Completa (Massiva) de Company Tags via OFFSET ---")
