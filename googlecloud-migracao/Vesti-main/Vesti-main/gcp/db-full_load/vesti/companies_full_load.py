...
LOG_FILE = "/home/diego/populate/full_load_companies.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
CSV_FILE = "/tmp/full_load_temp_companies.csv"
...
def run_full_load():
    logging.info("--- Iniciando Carga Completa (Massiva) de Companies via OFFSET ---")
    ...
    try:
        ...
        with SSHTunnelForwarder(
            ...
            while True:
                ...
                query = f"SELECT * FROM companies ORDER BY id ASC LIMIT {BATCH_SIZE} OFFSET {offset}"
